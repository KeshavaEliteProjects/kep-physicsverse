...
CURRICULUM = {
    "mechanics": [
        {
            "title": "Units, Dimensions & Vectors",
            "concepts": [
                ["Physical quantities", "physicalQuantities"],
                ["SI units", "siUnits"],
                ["Dimensions", "dimensions"],
                ["Dimensional analysis", "dimensionalAnalysis"],
                ["Scalars and vectors", "scalarsVectors"],
                ["Vector addition", "vectors"],
                ["Vector resolution", "vectorResolution"],
            ],
        },

        {
            "title": "Kinematics",
            "concepts": [
                ["Position and displacement", "kinematics1d"],
                ["Distance", "kinematics1d"],
                ["Speed and velocity", "kinematics1d"],
                ["Acceleration", "kinematics1d"],
                ["Uniform motion", "kinematics1d"],
                ["Uniformly accelerated motion", "kinematics1d"],
                ["Motion graphs", "kinematics1d"],
...

        {
            ...
            "concepts": [
                ["Newton's First Law", "newton2"],
                ["Newton's Second Law", "newton2"],
                ["Newton's Third Law", "newton2"],
                ["Force", "newton2"],
                ["Mass", "newton2"],
                ["Weight", "newton2"],
                ["Free-body diagrams", "newton2"],
                ["Normal force", "incline"],
                ["Tension", "pulley"],
                ["Friction", "newton2"],
                ["Inclined plane", "incline"],
                ["Connected bodies", "pulley"],
...

        {
            ...
            "concepts": [
                ["Work", "energyramp"],
                ["Work-energy theorem", "energyramp"],
                ["Kinetic energy", "energyramp"],
                ["Potential energy", "energyramp"],
                ["Conservation of energy", "energyramp"],
                ["Power", "energyramp"],
                ["Conservative forces", "energyramp"],
                ["Spring energy", "spring"],
                ["Energy diagrams", "energyramp"],
                ["Energy Skate Ramp", "energyramp"],
            ],
        },
...

        {
            ...
            "concepts": [
                ...
                ["Centripetal acceleration", "banked"],
                ["Centripetal force", "banked"],
                ["Banked roads", "banked"],
                ["Banked curve", "banked"],
                ["Conical pendulum", "conical"],
                ["Vertical circular motion", "verticalloop"],
            ],
        },
...

        {
            "title": "Gravitation",
            "concepts": [
                ["Universal law of gravitation", "gravitationlaw"],
                ["Gravitational field", "gravfield"],
                ["Gravitational potential", "gravpotential"],
                ["Escape velocity", "escapevelocity"],
                ["Orbital velocity", "orbitalvelocity"],
                ["Satellites", "satellites"],
                ["Kepler's laws", "kepler"],
                ["Gravity & Orbits", "orbit"],
            ],
        },

        {
            "title": "Oscillations",
            "concepts": [
                ["Periodic motion", "periodicmotion"],
                ["SHM", "shm"],
                ["Simple pendulum", "pendulum"],
                ["Mass-spring oscillator", "spring"],
                ["Energy in SHM", "energyshm"],
                ["Damping", "damping"],
                ["Resonance", "resonance"],
            ],
        },
    ...
    "electricity": [
        {
            ...
            "concepts": [
                ["Electric charge", "charges"],
                ["Coulomb's law", "charges"],
                ["Electric field", "charges"],
                ["Electric field lines", "charges"],
                ["Electric potential", "charges"],
                ["Potential difference", "charges"],
                ["Electric dipole", "charges"],
                ["Gauss's law", "charges"],
                ["Capacitance", "capacitor"],
                ["Capacitors", "capacitor"],
                ["Energy stored in capacitor", "capacitor"],
            ],
        },

        {
            ...
            "concepts": [
                ["Electric current", "ohms"],
                ["Drift velocity", "ohms"],
                ["Resistance", "ohms"],
                ["Resistivity", "ohms"],
                ["Ohm's law", "ohms"],
                ["Series circuits", "seriesparallel"],
                ["Parallel circuits", "seriesparallel"],
                ["Kirchhoff's laws", "seriesparallel"],
                ["Wheatstone bridge", "seriesparallel"],
                ["Meter bridge", "seriesparallel"],
                ["Electrical power", "ohms"],
                ["Heating effect", "ohms"],
            ],
        },
...

        {
            ...
            "concepts": [
                ["Ohm's Law", "ohms"],
                ["Series/parallel circuits", "seriesparallel"],
                ["Kirchhoff circuit", "seriesparallel"],
    ...
    "magnetism": [
        {
            ...
            "concepts": [
                ...
                ["Magnetic field lines", "barmagnet"],
                ["Earth's magnetic field", "barmagnet"],
                ["Magnetic force", "chargeinB"],
            ],
        },

        {
            ...
            "concepts": [
                ["Lorentz force", "chargeinB"],
                ["Charged particle in magnetic field", "chargeinB"],
                ["Velocity selector", "chargeinB"],
                ["Cyclotron", "chargeinB"],
            ],
        },

        {
            "title": "Current & Magnetism",
            "concepts": [
                ["Biot-Savart law", "wireB"],
                ["Ampere's law", "wireB"],
                ["Straight conductor", "wireB"],
                ["Circular loop", "wireB"],
                ["Solenoid", "wireB"],
                ["Toroid", "wireB"],
            ],
...

        {
            ...
            "concepts": [
                ["Magnetic field mapping", "barmagnet"],
                ["Charged particle motion", "chargeinB"],
                ["Solenoid", "wireB"],
    ...
    "optics": [
        {
            ...
            "concepts": [
                ...
                ["Mirrors", "lens"],
                ["Mirror equation", "lens"],
                ["Lenses", "lens"],
                ["Lens equation", "lens"],
                ["Magnification", "lens"],
                ["Prism", "prism"],
                ["Optical instruments", "lens"],
            ],
        },

        {
            "title": "Wave Optics",
            "concepts": [
                ["Huygens principle", "doubleslit"],
                ["Interference", "doubleslit"],
                ["Young's double-slit experiment", "doubleslit"],
                ["Diffraction", "doubleslit"],
                ["Polarization", "doubleslit"],
            ],
        },

        {
            "title": "Interactive Labs",
            "concepts": [
                ["Mirror experiment", "lens"],
                ["Lens experiment", "lens"],
                ["Prism", "prism"],
                ["Refraction", "refraction"],
                ["Total internal reflection", "refraction"],
    ...
    "thermodynamics": [
        {
            ...
            "concepts": [
                ["Temperature", "gasbox"],
                ["Heat", "heatconduction"],
                ["Thermal expansion", "heatconduction"],
                ["Specific heat", "heatconduction"],
                ["Calorimetry", "heatconduction"],
                ["Heat transfer", "heatconduction"],
            ],
        },

        {
            ...
            "concepts": [
                ["System and surroundings", "pvdiagram"],
                ["Internal energy", "pvdiagram"],
                ["Work", "pvdiagram"],
                ["First law", "pvdiagram"],
                ["Isothermal process", "pvdiagram"],
                ["Adiabatic process", "pvdiagram"],
                ["Isobaric process", "pvdiagram"],
                ["Isochoric process", "pvdiagram"],
                ["Second law", "carnot"],
                ["Entropy", "carnot"],
                ["Heat engines", "carnot"],
                ["Refrigerators", "carnot"],
    ...
    "waves": [
...

        {
            ...
            "concepts": [
                ["Wave motion", "wavestring"],
                ["Wavelength", "wavestring"],
                ["Frequency", "wavestring"],
                ["Amplitude", "wavestring"],
                ["Wave velocity", "wavestring"],
                ["Transverse waves", "wavestring"],
                ["Longitudinal waves", "wavestring"],
                ["Superposition", "beats"],
                ["Standing waves", "standingwave"],
            ],
        },

        {
            "title": "Sound",
            "concepts": [
                ["Sound waves", "wavestring"],
                ["Speed of sound", "wavestring"],
                ["Beats", "beats"],
                ["Doppler effect", "doppler"],
                ["Resonance", "standingwave"],
                ["Pipes", "standingwave"],
                ["Strings", "standingwave"],
            ],
        },
    ...
    "modern": [
        {
            ...
            "concepts": [
                ...
                ["Planck's hypothesis", "photoelectric"],
                ["Photoelectric effect", "photoelectric"],
                ["Matter waves", "matterwave"],
                ["de Broglie wavelength", "matterwave"],
                ["Heisenberg uncertainty", "matterwave"],
            ],
        },
    ...
    "fluids": [
        {
            ...
            "concepts": [
                ...
                ["Atmospheric pressure", "pressuredepth"],
                ["Hydrostatic pressure", "pressuredepth"],
            ],
        },

        {
            ...
            "concepts": [
                ...
                ["Flow rate", "bernoulli"],
                ["Bernoulli's principle", "bernoulli"],
                ["Venturi effect", "bernoulli"],
                ["Torricelli's law", "bernoulli"],
            ],
        },

        {
            ...
            "concepts": [
                ...
                ["Viscosity", "bernoulli"],
                ["Surface tension", "pressuredepth"],
                ["Capillarity", "pressuredepth"],
            ],
        },

        {
            ...
            "concepts": [
                ...
                ["Water flow", "bernoulli"],
                ["Bernoulli experiment", "bernoulli"],
            ],
        },
    ],
    ...
    "engineering": [
...

        {
            ...
            "concepts": [
                ["Projectile & thrust", "projectile"],
                ["Rocket motion", "rocket"],
                ["Thrust", "rocket"],
                ["Drag", "rocket"],
...

        {
            ...
            "concepts": [
                ...
                ["Hydroelectric systems", "renewable"],
            ],
        },
    ],
    ...
    "astrophysics": [
        {
            ...
            "concepts": [
                ...
                ["Kepler's laws", "kepler"],
                ["Gravity", "orbit"],
                ["Seasons", "planetsystem"],
                ["Moon phases", "planetsystem"],
            ],
        },
        ...
        {
            "title": "Extreme Objects",
            "concepts": [
                ["White dwarfs", "stars"],
                ["Neutron stars", "gravitywell"],
                ["Black holes", "gravitywell"],
                ["Event horizon", "gravitywell"],
                ["Gravitational waves", "gravitywell"],
            ],
        },
...
def build_topic(topic_id):
    meta = next(
        (t for t in TOPIC_META if t["id"] == topic_id),
        None,
    )
